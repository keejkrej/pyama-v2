...
fn usage() -> String {
    [
        "Usage:",
        "  cargo run -p pyama --bin crop-profiler -- --source <PATH> --workspace <DIR> --pos <N> --plane-offset <N> --batch <N> --output-root <DIR> [--json]",
        "",
        "Examples:",
        "  cargo run -p pyama --bin crop-profiler -- --source C:\\data\\input.nd2 --workspace C:\\data\\ws --pos 7 --plane-offset 0 --batch 50 --output-root D:\\scratch\\crop-profile",
        "  cargo run -p pyama --bin crop-profiler -- --source C:\\data\\source_tifs --workspace C:\\data\\ws --pos 2 --plane-offset 10 --batch 12 --output-root D:\\scratch\\crop-profile --json",
    ]
    .join("\n")
}
