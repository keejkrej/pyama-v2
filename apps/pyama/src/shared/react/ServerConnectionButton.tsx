...
import { getWebSocketUrl } from "../host/hostPorts";
...
export type ServerConnectionButtonProps = {
  className?: string;
...
export function ServerConnectionButton({
  ...
  const apply = useCallback(() => {
    ...
    if (trimmed === "") {
      next.searchParams.delete(WS_URL_PARAM);
    } else {
      next.searchParams.set(WS_URL_PARAM, trimmed);
    }
